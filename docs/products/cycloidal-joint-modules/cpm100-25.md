...
![CPM-100-25 cycloidal robot joint module without integrated driver, output-side view](../../assets/images/products/cycloidal-joint-modules/cpm100-25/cpm100-25-no-driver-output-angle.webp){ width="720" loading="lazy" }
...
| --- | --- |
| ![CPM-100-25 cycloidal joint module without integrated driver, output-side angle](../../assets/images/products/cycloidal-joint-modules/cpm100-25/cpm100-25-no-driver-output-angle.webp) | ![CPM-100-25 cycloidal joint module with integrated driver, output-side angle](../../assets/images/products/cycloidal-joint-modules/cpm100-25/cpm100-25-with-driver-output-angle.webp) |
